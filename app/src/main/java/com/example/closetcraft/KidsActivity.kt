...
class KidsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupRecyclerView()
        setupNavigation()
        fetchProductsForCategory("kid's clothing")
    }
        ...
        RetrofitClient.instance.getProductsByCategory(category)
            .enqueue(object : Callback<List<Product>> {
                override fun onResponse(call: Call<List<Product>>, response: Response<List<Product>>) {
                    if (response.isSuccessful) {
                        ...
                        if (products != null && products.isNotEmpty()) {
                            ...
                            Toast.makeText(this@KidsActivity, "No products found.", Toast.LENGTH_SHORT).show()
                        }
                    } else {
                        Toast.makeText(
                            this@KidsActivity,
                ...
                override fun onFailure(call: Call<List<Product>>, t: Throwable) {
                    Log.e("KidsActivity", "API call failed", t)
                    Toast.makeText(this@KidsActivity, "Error: ${t.message}", Toast.LENGTH_LONG).show()
                }
            })
    }
