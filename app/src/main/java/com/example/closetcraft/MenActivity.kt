...
class MenActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupNavigation()
        setupFilterButton()
        fetchProductsForCategory("men's clothing")
    }
            ...
            .enqueue(object : Callback<List<Product>> {
                override fun onResponse(call: Call<List<Product>>, response: Response<List<Product>>) {
                    if (response.isSuccessful) {
                        ...
                        Toast.makeText(this@MenActivity, "Failed: ${response.code()}", Toast.LENGTH_SHORT).show()
                    }
                }

                override fun onFailure(call: Call<List<Product>>, t: Throwable) {
                    Log.e("MenActivity", "API call failed", t)
                    Toast.makeText(this@MenActivity, "Error: ${t.message}", Toast.LENGTH_LONG).show()
                }
            })
    }
